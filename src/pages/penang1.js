...
const Penang1 = () => {
    ...
    const correctAnswer = "Pearl of the Orient";
    ...
    return (
        <div className="container">
            ...
            <div className="question">What is Penang also known as?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Pearl of the Orient", "Lion City", "Garden City", "Land Below the Wind"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is a nickname given to Penang, reflecting its rich cultural heritage and scenic beauty.
                        </div>
