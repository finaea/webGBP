...
const Food4 = () => {
    ...
    const correctAnswer = "Coconut milk";
    ...
    const goToNextQuestion = () => {
        setShowPopup(false);
        navigate('/food5'); // Update this to navigate to the next question page
    };
    ...
    return (
        <div className="container">
            ...
            <div className="question">What is the main ingredient in the dish "Nasi Lemak"?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Soy sauce", "Fish sauce", "Chili paste", "Coconut milk"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is essential in Nasi Lemak, giving the rice its creamy and fragrant flavor.
                        </div>
