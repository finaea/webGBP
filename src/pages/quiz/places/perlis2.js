...
const Perlis2 = () => {
    ...
    const correctAnswer = "Laksa Perlis";
    ...
    return (
        <div className="container">
            ...
            <div className="question">Which traditional dish from Perlis is known for its spicy and tangy flavor?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Laksa Perlis", "Nasi Dagang", "Sambal Perlis", "Perlis Satay"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is a famous spicy and tangy noodle soup enjoyed in Perlis, known for its unique flavor profile.
                        </div>
