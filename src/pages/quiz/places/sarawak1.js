...
const Sarawak1 = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="question">What is the capital city of Sarawak known for its riverside setting and vibrant markets?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Miri", "Sibu", "Kuching", "Bintulu"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> Kuching is renowned for its picturesque riverside setting, bustling markets, and diverse cultural influences, reflecting its rich history as a trading and colonial town.
                        </div>
