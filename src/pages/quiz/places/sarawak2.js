...
const Sarawak2 = () => {
    ...
    const correctAnswer = "Sarawak Regatta";
    ...
    return (
        <div className="container">
            ...
            <div className="question">Which festival is celebrated with boat races on the Sarawak River?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Sarawak Regatta", "Kuching Water Festival", "Miri Boat Race", "Bintulu Dragon Boat Festival"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is a significant cultural event in Sarawak, drawing large crowds to witness the thrilling boat races that highlight the community spirit and competitive tradition of the local people.
                        </div>
