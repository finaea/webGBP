...
const Perlis5 = () => {
    ...
    const correctAnswer = "Andaman Sea";
    ...
    return (
        <div className="container">
            ...
            <div className="question">What body of water borders Perlis to the west?</div>
            <form action="" className="form">
                {showPopup ? null : (
                    ["Strait of Malacca", "Andaman Sea", "South China Sea", "Gulf of Thailand"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> borders Perlis to the west. This body of water plays a crucial role in the maritime activities of the region, influencing the climate and coastal ecosystems. It is part of a significant maritime route that facilitates international trade and economic activities.
                        </div>
