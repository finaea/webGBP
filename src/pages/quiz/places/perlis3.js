...
const Perlis3 = () => {
    ...
    const correctAnswer = "Perlis Agricultural Institute";
    ...
    const goToNextQuestion = () => {
        setShowPopup(false);
        navigate('/perlis4'); // Update this to navigate to the next question page in the Perlis series
    };
    ...
    return (
        <div className="container">
            ...
            <div className="question">Which institution in Perlis is renowned for its research in agricultural science?</div>
            <form action="" className="form">
                {showPopup ? null : (
                    ["Universiti Malaysia Perlis (UniMAP)", "Perlis Agricultural Institute", "Perlis Science Foundation", "Institute of Sustainable Agrotechnology (INSAT)"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is renowned for its contributions to agricultural science and research, playing a key role in advancing farming techniques in Perlis.
                        </div>
