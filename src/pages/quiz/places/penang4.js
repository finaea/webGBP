...
const Penang4 = () => {
    ...
    const correctAnswer = "Being one of the longest bridges in Southeast Asia";
    ...
    return (
        <div className="container">
            <div className="top-right-info">
                <div className="question-number">Question 6 out of 10</div>
            ...
            <div className="question">What is the Penang Bridge known for?</div>
            <form action="" className="form">
                {showPopup ? null : (
                    ["Having a glass-bottomed section", "Being the oldest bridge in Malaysia", "Being one of the longest bridges in Southeast Asia", "Connecting Malaysia to Singapore"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is noted for being one of the longest bridges in Southeast Asia, linking Penang Island to the mainland.
                        </div>
                        <img
