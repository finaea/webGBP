...
const Food6 = () => {
    ...
    const correctAnswer = "Flat rice noodles";
    ...
    return (
        <div className="container">
            ...
            <div className="question">What type of noodles is used in "Char Kuey Teow"?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Vermicelli", "Egg noodles", "Flat rice noodles", "Glass noodles"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is used in Char Kuey Teow, a popular Malaysian street food known for its rich, savory flavors.
                        </div>
