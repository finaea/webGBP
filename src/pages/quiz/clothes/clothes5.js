...
const Clothes5 = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="question">Which part of the Baju Melayu is a folded and stitched cloth worn around the waist?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Sampin", "Sash", "Belt", "Turban"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            The <b>{correctAnswer}</b>, a key component of the Baju Melayu, is worn around the waist to enhance the formality of the attire.
                        </div>
