...
const Clothes4 = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="question">What is the common fabric choice for making a Cheongsam in Malaysia?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Velvet", "Linen", "Silk", "Denim"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is highly valued for its comfort, aesthetic, and traditional importance in the making of Cheongsams in Malaysia.
                        </div>
