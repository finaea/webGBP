...
const Clothes2 = () => {
    ...
    return (
        <div className="container">
            ...
            <div className="question">What is the traditional Indian attire that is popular among Malaysian Indian communities?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Kimono", "Sari", "Kebaya", "Sherwani"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is a traditional Indian attire known for its grace and elegance, deeply rooted in the cultural traditions of the Indian community in Malaysia.
                        </div>
