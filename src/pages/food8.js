...
const Food8 = () => {
    ...
    const goToNextQuestion = () => {
        setShowPopup(false);
        navigate('/food9'); // Update this to navigate to the next question page
    };
    ...
    return (
        <div className="container">
            <div className="top-right-info">
                <div className="question-number">Question 8 out of 10</div>
            ...
            <div className="question">What is the key ingredient in "Asam Pedas"?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Coconut milk", "Soy sauce", "Tamarind", "Palm sugar"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is essential in Asam Pedas, giving the dish its signature sour and tangy flavor.
                        </div>
