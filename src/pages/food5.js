...
const Food5 = () => {
    ...
    const correctAnswer = "Ikan Bakar";
    ...
    const goToNextQuestion = () => {
        setShowPopup(false);
        navigate('/food6'); // Update this to navigate to the next question page
    };
    ...
    return (
        <div className="container">
            ...
            <div className="question">Which dish is known as a traditional Malay grilled fish?</div>
            <img
            ...
            <form action="" className="form">
                {showPopup ? null : (
                    ["Ikan Bakar", "Ayam Goreng", "Sambal Udang", "Kari Ayam"].map((answer, index) => (
                        <input
                            key={index}
                ...
                <div className="popup">
                    <div className={`popup-content ${popupBorderColor === 'green' ? 'correct-border' : (popupBorderColor === 'red' ? 'wrong-border' : '')}`} ref={popupContentRef}>
                        ...
                        <div className="popup-description">
                            ...
                            <b>{correctAnswer}</b> is a traditional Malay dish of grilled fish marinated with spices and served with a tangy sauce.
                        </div>
